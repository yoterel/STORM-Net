...
def parse_arguments():
    ...
    #     sys.exit(1)
    cmd_line = 'E:/University/masters/CapTracking/videos/telaviv/yaara/session1/1.MP4 E:/Src/CapCalibrator/example_models/example_model2.txt -gt E:/University/masters/CapTracking/videos_data/yaara -m special -v 1'.split()
