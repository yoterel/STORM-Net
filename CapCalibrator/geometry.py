...
def apply_rigid_transform(r_matrix, s_matrix, model_path, gt_file, v):
    ...
    visualize_pc(np.vstack((base_model_data_in_sim_space.T[face_indices, :], temp_sticker_data)),
    ...
    if gt_file:
        ...
        if v:
            print("RMSE error (prediction, gt):", rmse_1)
